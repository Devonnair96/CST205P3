...
def createRooms(img1, img2, item):
    ...
    if gold >= 250:
        button1 = Button(frame1, image = photoImage1, text = "Gold Price: 250", compound = BOTTOM, command = lambda: resetGold(item, 1))
        button1.photoImage1 = photoImage1
        button1.pack(side = RIGHT)
    button2 = Button(frame1, image = photoImage2, text = "Gold Price: 0", compound = BOTTOM ,command = lambda: reset(item, 2))
...
newWindow = Tk()
messagebox.showinfo("Welcome Adventurer!", "There's a nasty dragon at the end of this dungeon that we need you to clear out. Here is 500 gold, you can buy equipment in the rooms beyond to help you with your battle. Good luck and remember, we're all counting on you...")
mytext = StringVar()
goldamount = StringVar()
goldamount.set("Gold: " + str(gold))
global goldLabel
